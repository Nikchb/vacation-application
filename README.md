...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/com/camunda/vacation_application/vacation_application/ProcessTest.java) in your IDE or using:
...
```bash
java -jar target/vacation-application.jar
```
